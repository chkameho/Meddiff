...
if Leukozyten_Wert != 0:
    gewählte_Patienten_Daten_gedreht["Einheit: G/L"] = gewählte_Patienten_Daten_gedreht.apply(lambda row: (Leukozyten_Wert / 100.00) * float(row["Einheit: %"]), axis=1)

    #gewählte_Patienten_Daten_gedreht["Einheit: G/L"]= (Leukozyten_Wert / 100.00) #* float(gewählte_Patienten_Daten_gedreht["Einheit: %"])
